  ...
  <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                {!! Form::open(array('route' => 'riders.store','method'=>'POST','id'=>'form','enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::password('password', array('placeholder' => 'Enter password','class' => 'form-control','required'=>'true','minlength'=>'4')) !!}
