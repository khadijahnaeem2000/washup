                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('name', null, array('placeholder' => 'Enter customer name','class' => 'form-control','autofocus' => '','required'=>'true','minlength'=>'3')) }}
                                    @if ($errors->has('name'))  
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::number('in_amount', null, array('placeholder' => 'Enter current amount','class' => 'form-control')) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('permanent_note', null, array('placeholder' => 'Enter permanent note','class' => 'form-control')) }}
                        ...
                        <div class="form-group row">
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                                ...
                                {{ Form::hidden('radius', 0, array('placeholder' => 'Enter radius in meters','class' => 'form-control','id'=>'radius')) }}
                                                            ...
                                                            if($value->id ==$service_id ){?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span class="switch switch-outline switch-icon switch-primary">
                                                                            <label>
                                                                                {!! Form::checkbox("item_status[$service_id][$value->item_id]", 1, true,array("class" => "form-control")) !!}
                                                                                <span></span> 
                                                                            </label>
                                                                        </span>
                                                                    </td>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="40%">
                                                    <span class="switch switch-outline switch-icon switch-primary">
                                                        <label>
                                                            {!! Form::checkbox("email_alert", 1, true,array("class" => "form-control")) !!}
                                                            <span></span> 
                                                        </label>
                                                    </span>
                                                </th>
