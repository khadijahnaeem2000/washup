                                ...
                                <tr>
                                    <td>
                                        @if(isset($record->start_img))
                                            <img src="{{ asset('/uploads/meters/'.$record->start_img) }}" class="img_cls">
                                        @else
                                            <img src="{{ asset('/uploads/users/no_image.png') }}" class="img_cls">
                                        @endif
                                    </td>
                                    <td>
                                        @if(isset($record->end_img))
                                            <img src="{{ asset('/uploads/meters/'.$record->end_img) }}" class="img_cls">
                                        @else
                                            <img src="{{ asset('/uploads/users/no_image.png') }}" class="img_cls">
                                        @endif
                                    </td>
