...
// });
	...
	Route::get('/send_sms/{orderId}',[App\Http\Controllers\NotificationController::class, 'send_sms']);
		Route::get('/send_modifiedsms/{orderId}',[App\Http\Controllers\NotificationController::class, 'send_modifiedsms']);
	Route::get('/order/view/{uuid}', [App\Http\Controllers\NotificationController::class, 'viewOrder'])->name('order.view');
...
Route::get('/', function () {
	...
	Route::resource('/paymentreport', App\Http\Controllers\PaymentReportController::class);
	Route::post('paymentreport/fuel_list', [App\Http\Controllers\PaymentReportController::class, 'list']);
	Route::get('paymentreport/show/{id}', [App\Http\Controllers\PaymentReportController::class, 'show'])->name('paymentreport_show');
	Route::post('paymentreport/editcustomerwallet', [App\Http\Controllers\PaymentReportController::class, 'editcustomerwallet'])->name('editcustomerwallet');
	Route::post('paymentreport/lock', [App\Http\Controllers\PaymentReportController::class, 'toggleLock'])->name('paymentreport_lock');
	Route::post('paymentreport_check_lock', [App\Http\Controllers\PaymentReportController::class, 'checkLockStatus'])->name('paymentreport_check_lock');
...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::post('fuel_report/lock', [App\Http\Controllers\Fuel_ReportController::class, 'toggleLock'])->name('fuel_reports_lock');
		Route::post('fuel_report/unlock', [App\Http\Controllers\Fuel_ReportController::class, 'toggleUnLock'])->name('fuel_reports_unlock');
